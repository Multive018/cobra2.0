...
import { update_post_process_intake_dates, update_post_trade_variables } from '@/lib/stack_pricing_utils';
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    await update_daily_summary(summary_id as number, process_summary as ProcessSummary,outbound_weight as number,
      ...
      xbs_report.work_in_progress_quantity as number,
      xbs_report.blocked_for_processing_quantity as number
    );
    ...
    await update_post_process_intake_dates()
