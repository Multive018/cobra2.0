...
export async function POST(request: NextRequest) {
  try {
    ...
    const total_delivered_qty = await processStiFile(stiFile, summary_id_int,current_stock_file);
    await update_raw_material__intake_date(current_stock_file as File);
    // ---
